...
### Types de métriques supportées par OpenTelemetry
...
Des spécifications + des conventions de nommage = données de métriques pré-agrégées 

prometheus sotckage : clé/timestamp/valeur
